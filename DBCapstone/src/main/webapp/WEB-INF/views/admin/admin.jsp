	...
	<section id="j-slider">
		<div class="slide-main">
			...
			<div class="single-slider"
				style="background-image: url(/res/images/slider/slider_bg1.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-sm-12 col-xs-12">
							<!-- Slider Text -->
			...
			<!-- Single Slider -->
			<div class="single-slider"
				style="background-image: url(/res/images/slider/slider_bg2.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-sm-12 col-xs-12">
							<!-- Slider Text -->
			...
			<!-- Single Slider -->
			<div class="single-slider"
				style="background-image: url(/res/images/slider/slider_bg3.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-sm-12 col-xs-12">
							<!-- Slider Text -->
			...
			<div class="row">
				<div class="col-md-6 col-sm-12 col-xs-12 wow fadeIn">
					...
					<div class="info-main">
						...
						<ul class="info-list">
							<li><i class="fa fa-check"></i>consectetuer adipiscing elit,
								sed diam nonummy.</li>
							<li><i class="fa fa-check"></i>has been the
								industry'sstandar.</li>
							<li><i class="fa fa-check"></i>has been the
								industry'sstandar.</li>
							<li><i class="fa fa-check"></i>Pellentesque habitant morbi
								tristique senectus.</li>
						</ul>
					</div>
					<!--/ End Info Main -->
				</div>
